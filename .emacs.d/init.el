...
(custom-set-variables
 ...
 '(ibuffer-saved-filters (quote (("no-special" ((not derived-mode . dired-mode) (not name . "\\*.+\\*") (not derived-mode . special-mode))) ("gnus" ((or (mode . message-mode) (mode . mail-mode) (mode . gnus-group-mode) (mode . gnus-summary-mode) (mode . gnus-article-mode)))) ("programming" ((or (mode . emacs-lisp-mode) (mode . cperl-mode) (mode . c-mode) (mode . java-mode) (mode . idl-mode) (mode . lisp-mode))))))))
(custom-set-faces
