...
function! s:RunTestFile()
  ...
  elseif g:CurrentTestExt == "js"
    execute "w\|!TEST=true NODE_ENV=test NODE_PATH=./lib:./test/unit:./test/integration mocha -t 5000 -u bdd -R spec -c " . g:CurrentTestFile 
  elseif g:CurrentTestExt == "coffee"
    execute "w\|!TEST=true NODE_ENV=test jasmine-node --coffee " . g:CurrentTestFile
  endif
endfunction
